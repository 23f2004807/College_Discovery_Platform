...
from models import db, User, College, Cutoff, Review
...
def seed_database():
    ...
    # 2. Add Users
    admin = User(email="admin@college.com", role="admin")
    admin.set_password("AdminPass123!")
    
    user = User(email="user@college.com", role="user")
    ...
    db.session.commit()
    print("Database successfully seeded with 10 top-tier colleges, cutoffs, and mock reviews!")
